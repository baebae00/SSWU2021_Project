...
// 영어영문학과
public class LiberalMajorEnglish extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/english/16689/subview.do";
    ...
    private void getData(){
        LiberalMajorEnglish.MelonJsoup jsoupAsyncTask = new LiberalMajorEnglish.MelonJsoup();
