...
public class LiberalMajorHistory extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/history/11355/subview.do";
    ...
    private void getData(){
        LiberalMajorHistory.MelonJsoup jsoupAsyncTask = new LiberalMajorHistory.MelonJsoup();
