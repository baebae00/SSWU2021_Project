...
public class FragmentMarketing extends Fragment {
    ...
    String contest_chart_url = "https://www.jungle.co.kr/contest/filter?categoryCode=CTC007";
    ...
    private void getData(){
        FragmentMarketing.MelonJsoup jsoupAsyncTask = new FragmentMarketing.MelonJsoup();
