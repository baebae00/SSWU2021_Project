...
// 경제학과
public class SocialMajorEconomic extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/economic/11479/subview.do";
    ...
    private void getData(){
        SocialMajorEconomic.MelonJsoup jsoupAsyncTask = new SocialMajorEconomic.MelonJsoup();
