...
// 사회복지학과
public class SocialMajorWelfare extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/welfare/12067/subview.do";
    ...
    private void getData(){
        SocialMajorWelfare.MelonJsoup jsoupAsyncTask = new SocialMajorWelfare.MelonJsoup();
