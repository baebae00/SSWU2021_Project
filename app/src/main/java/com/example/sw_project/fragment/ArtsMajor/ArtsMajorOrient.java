...
// 동양학과
public class ArtsMajorOrient extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/orient/12352/subview.do";
    ...
    private void getData(){
        ArtsMajorOrient.MelonJsoup jsoupAsyncTask = new ArtsMajorOrient.MelonJsoup();
