...
// 지리학과
public class SocialMajorGeo extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/geographic/11450/subview.do";
    ...
    private void getData(){
        SocialMajorGeo.MelonJsoup jsoupAsyncTask = new SocialMajorGeo.MelonJsoup();
