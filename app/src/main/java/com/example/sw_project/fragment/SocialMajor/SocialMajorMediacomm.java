package com.example.sw_project.fragment.SocialMajor;
...
// 미디어커뮤니케이션학과
public class SocialMajorMediacomm extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/mediacomm/11530/subview.do";
    ...
    private void getData(){
        SocialMajorMediacomm.MelonJsoup jsoupAsyncTask = new SocialMajorMediacomm.MelonJsoup();
