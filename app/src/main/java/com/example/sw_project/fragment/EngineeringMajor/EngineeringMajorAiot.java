...
// AI융합학부
public class EngineeringMajorAiot extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/aiot/16887/subview.do";
    ...
    private void getData(){
        EngineeringMajorAiot.MelonJsoup jsoupAsyncTask = new EngineeringMajorAiot.MelonJsoup();
