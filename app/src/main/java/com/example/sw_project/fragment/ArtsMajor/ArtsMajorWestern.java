...
// 서양학과
public class ArtsMajorWestern extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/western/12380/subview.do";
    ...
    private void getData(){
        ArtsMajorWestern.MelonJsoup jsoupAsyncTask = new ArtsMajorWestern.MelonJsoup();
