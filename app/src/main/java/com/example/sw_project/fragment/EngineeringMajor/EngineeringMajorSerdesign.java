package com.example.sw_project.fragment.EngineeringMajor;
...
// 서비스디자인공학과
public class EngineeringMajorSerdesign extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/serdesign/17822/subview.do";
    ...
    private void getData(){
        EngineeringMajorSerdesign.MelonJsoup jsoupAsyncTask = new EngineeringMajorSerdesign.MelonJsoup();
    ...
    public class MelonJsoup extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                final Elements rank_list1 = doc.select("td._artclTdTitle a.artclLinkView");
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int i = 0; i < listName.size(); i++) {
                            if (reportDate.get(i).contains("2021")) {
