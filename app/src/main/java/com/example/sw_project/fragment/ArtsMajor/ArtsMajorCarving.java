...
// 조소과
public class ArtsMajorCarving extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/carving/12408/subview.do";
    ...
    private void getData(){
        ArtsMajorCarving.MelonJsoup jsoupAsyncTask = new ArtsMajorCarving.MelonJsoup();
