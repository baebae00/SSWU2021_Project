...
public class LiberalMajorGerman extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/german/11225/subview.do";
    ...
    private void getData(){
        LiberalMajorGerman.MelonJsoup jsoupAsyncTask = new LiberalMajorGerman.MelonJsoup();
