...
// 국어국문학과
public class LiberalMajorKorean extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/korean/16680/subview.do";
    ...
    private void getData(){
        LiberalMajorKorean.MelonJsoup jsoupAsyncTask = new LiberalMajorKorean.MelonJsoup();
