...
public class LiberalMajorChinese extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/chinese/16696/subview.do";
    ...
    private void getData(){
        LiberalMajorChinese.MelonJsoup jsoupAsyncTask = new LiberalMajorChinese.MelonJsoup();
