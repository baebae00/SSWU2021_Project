...
public class LiberalMajorFrance extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/france/16684/subview.do";
    ...
    private void getData(){
        LiberalMajorFrance.MelonJsoup jsoupAsyncTask = new LiberalMajorFrance.MelonJsoup();
