...
public class FragmentDesign extends Fragment {
    ...
    String contest_chart_url = "https://www.jungle.co.kr/contest/filter?categoryCode=CTC002";
    ...
    private void getData(){
        FragmentDesign.MelonJsoup jsoupAsyncTask = new FragmentDesign.MelonJsoup();
