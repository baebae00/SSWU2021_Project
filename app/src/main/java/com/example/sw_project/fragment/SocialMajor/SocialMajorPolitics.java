...
// 정치외교학과
public class SocialMajorPolitics extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/politics/11395/subview.do";
    ...
    private void getData(){
        SocialMajorPolitics.MelonJsoup jsoupAsyncTask = new SocialMajorPolitics.MelonJsoup();
