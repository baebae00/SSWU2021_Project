...
// 심리학과
public class SocialMajorPsy extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;

    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/psy/11421/subview.do";
    ...
    private void getData(){
        SocialMajorPsy.MelonJsoup jsoupAsyncTask = new SocialMajorPsy.MelonJsoup();
