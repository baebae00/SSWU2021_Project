...
// 산업디자인과
public class ArtsMajorIndusdesign extends Fragment {

    // private RecyclerView recyclerView;
    private RecyclerViewEmptySupport recyclerView;
    private SSWURecyclerAdapter adapter;
    String contest_chart_url = "https://www.sungshin.ac.kr/indusdesign/12478/subview.do";
    ...
    private void getData(){
        ArtsMajorIndusdesign.MelonJsoup jsoupAsyncTask = new ArtsMajorIndusdesign.MelonJsoup();
